...
13. To launch Robobo use one of the following:
	* black - rosrun robobo_line line 0 8 0 8 8 0.8 _image_transport:=compressed ;
    * red - rosrun robobo_line line 1 8 0 8 8 0.8 _image_transport:=compressed;
    * green - rosrun robobo_line line 2 8 0 8 8 0.8 _image_transport:=compressed;
    * blue - rosrun robobo_line line 3 8 0 8 8 0.8 _image_transport:=compressed.
14. If necessary, change the arguments:
